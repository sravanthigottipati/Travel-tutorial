...
const PLACES: Partial<Record<(typeof KNOWN_DESTINATIONS)[number], CandidatePlace[]>> = {
  ...
  // Paris/London/Tokyo/Dubai/Singapore/Bangkok: estimatedCost is in INR
  // like every other destination (the app's only currency, see the trip
  // budget field) — converted from approximate real-world local-currency
  // prices at ~96 INR/USD (checked live against frankfurter.app's
  // USD/EUR/GBP/JPY/THB rates; AED uses its fixed 3.6725/USD peg), then
  // rounded. A live QA pass caught these still holding their original
  // face-value numbers (e.g. "Burj Khalifa: 40" was 40 rupees, not $40)
  // — a jarring 50-80x undercount next to the rupee-scale Indian
  // destinations, since nothing else in the app tags a currency per field.
  paris: [
    { name: "Eiffel Tower visit", category: "photography", estimatedCost: 2900, durationHours: 2.5 },
    { name: "Louvre Museum", category: "museums", estimatedCost: 2100, durationHours: 3.5 },
    { name: "Montmartre walking tour", category: "history", estimatedCost: 0, durationHours: 2.5 },
    { name: "Seine river cruise", category: "relaxation", estimatedCost: 1700, durationHours: 1.5 },
    { name: "Le Marais food tour", category: "local food", estimatedCost: 4300, durationHours: 2 },
    { name: "Champs-Élysées shopping", category: "shopping", estimatedCost: 0, durationHours: 2 },
    { name: "Musée d'Orsay visit", category: "museums", estimatedCost: 1500, durationHours: 2.5 },
    { name: "Notre-Dame area heritage walk", category: "history", estimatedCost: 0, durationHours: 2 },
  ],
  london: [
    { name: "Tower of London tour", category: "history", estimatedCost: 3200, durationHours: 3 },
    { name: "British Museum visit", category: "museums", estimatedCost: 0, durationHours: 3 },
    { name: "West End show evening", category: "culture", estimatedCost: 5800, durationHours: 3 },
    { name: "Camden Market shopping", category: "shopping", estimatedCost: 1900, durationHours: 2.5 },
    { name: "Borough Market food tour", category: "local food", estimatedCost: 2900, durationHours: 2 },
  ...
  tokyo: [
    ...
    { name: "Shibuya Crossing & shopping", category: "shopping", estimatedCost: 3800, durationHours: 2.5 },
    { name: "Tsukiji Outer Market food tour", category: "local food", estimatedCost: 3400, durationHours: 2 },
    { name: "teamLab digital art museum", category: "museums", estimatedCost: 3100, durationHours: 2.5 },
    { name: "Shinjuku nightlife walk", category: "nightlife", estimatedCost: 3800, durationHours: 3 },
    { name: "Mount Fuji day trip", category: "adventure", estimatedCost: 8600, durationHours: 8 },
    { name: "Meiji Shrine walk", category: "culture", estimatedCost: 0, durationHours: 1.5 },
  ],
  dubai: [
    { name: "Burj Khalifa observation deck", category: "photography", estimatedCost: 3800, durationHours: 2 },
    { name: "Dubai Mall & fountain show", category: "shopping", estimatedCost: 1900, durationHours: 3 },
    { name: "Desert safari with BBQ dinner", category: "adventure", estimatedCost: 5800, durationHours: 5 },
    { name: "Old Dubai souk & abra ride", category: "history", estimatedCost: 1000, durationHours: 2.5 },
    { name: "Jumeirah Beach relaxation", category: "beaches", estimatedCost: 0, durationHours: 3 },
    { name: "Emirati cuisine dinner", category: "local food", estimatedCost: 3400, durationHours: 1.5 },
    { name: "Dubai Marina walk & skyline", category: "relaxation", estimatedCost: 0, durationHours: 1.5 },
  ],
  singapore: [
    { name: "Gardens by the Bay visit", category: "photography", estimatedCost: 1900, durationHours: 3 },
    { name: "Sentosa Island day", category: "adventure", estimatedCost: 4800, durationHours: 5 },
    { name: "Hawker centre food tour", category: "local food", estimatedCost: 1400, durationHours: 2 },
    { name: "Marina Bay Sands skypark", category: "photography", estimatedCost: 2200, durationHours: 1.5 },
    { name: "Chinatown & Little India walk", category: "culture", estimatedCost: 1000, durationHours: 2.5 },
    { name: "Orchard Road shopping", category: "shopping", estimatedCost: 0, durationHours: 2.5 },
    { name: "Singapore Zoo visit", category: "wildlife", estimatedCost: 3400, durationHours: 3 },
  ],
  bangkok: [
    { name: "Grand Palace & Wat Phra Kaew", category: "history", estimatedCost: 1400, durationHours: 3 },
    { name: "Chatuchak weekend market", category: "shopping", estimatedCost: 1900, durationHours: 3 },
    { name: "Chao Phraya river cruise", category: "relaxation", estimatedCost: 1000, durationHours: 1.5 },
    { name: "Street food tour, Yaowarat", category: "local food", estimatedCost: 1400, durationHours: 2 },
    { name: "Wat Arun sunset photography", category: "photography", estimatedCost: 300, durationHours: 1.5 },
    { name: "Khao San Road nightlife walk", category: "nightlife", estimatedCost: 1900, durationHours: 3 },
    { name: "Ayutthaya day trip", category: "adventure", estimatedCost: 3800, durationHours: 8 },
  ],
};
